...
<<<<<<< HEAD
    @if($button_show_data || $button_reload_data || $button_new_data || $button_delete_data || $indexButton || $columns)
        ...
        <ul class='nav nav-tabs'>
            <li style="background:#ffffff" class='active'>
                ...
                <a style="color:#111" onclick="if(confirm('Are you sure want to leave ?')) location.href='{{ CRUDBooster::mainpath("import-data") }}'" href='javascript:;'>
                    {!! cbIcon('download') !!} Upload aFile &raquo;</a>
            </li>
            <li style="background:#eeeeee"><a style="color:#111" href='#'>{!! cbIcon('cogs')  !!}Adjustment &raquo;</a>
            </li>
            <li style="background:#eeeeee"><a style="color:#111" href='#'>{!! cbIcon('cloud-download') !!} Importing
                    &raquo;</a></li>
=======
